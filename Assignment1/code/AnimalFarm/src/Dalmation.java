...
public class Dalmation extends Dog {
	...
	public Dalmation(int id, String name, int age, String type, String subType, String notes, String medicalCondition,
	...
	public void draw(Graphics g, ImagePanel imagePanel) {
		...
		try {                
	          image = ImageIO.read(new File("images/dalmatian.jpg"));
