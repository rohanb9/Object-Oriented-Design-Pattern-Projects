...
import com.animalfarm.classes.Mammal;
...
public class HumanSocietyCenter {
	...
	private static void drawAddAnimalForm() {
        ...
        addAnimalFrame.setTitle("Add New Animal Using Factory Design Pattern"); 
    ...
    static FeedingBehavior getFeedingBehaviorByText(String beh) {
		 ...
		 if(name.isEmpty() || ageText.getText().toLowerCase().isEmpty() || note.isEmpty() || med.isEmpty()) {
			 ...
			 try {
				 ...
				 if(type.equals("dogs") || type.equals("cats")) {
				  ...
				  newAnimal = afc.getAnimal(++idCount, nameText.getText(), age, typeText.getSelectedItem().toString(), breedText.getSelectedItem().toString(), noteText.getText(), medText.getText(), adoption, x, y+animalCount*incr);
    ...
    private static void showChangeFeedingBehaviorForm() {
    	
    	changeAnimalFeedingBehaviorFrame = new JFrame("Change animal feeding behavior");
        Dimension minDim = new Dimension(600,1000);
        changeAnimalFeedingBehaviorFrame.setMinimumSize(minDim);
        
        changeAnimalFeedingBehaviorFrame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
    ...
    private static void placeStrategyComponents(JPanel panel) {
    	 ...
    	 panel.setLayout(null);
	        ...
	        updateButton.addActionListener(new ActionListener()
			{
				...
				{			
					...
					selectedAnimal.setXY(100, 150);
					animalDecorationFrame = new JFrame("Animal Details");
					Dimension minDim = new Dimension(900,500);
				    animalDecorationFrame.setMinimumSize(minDim);
