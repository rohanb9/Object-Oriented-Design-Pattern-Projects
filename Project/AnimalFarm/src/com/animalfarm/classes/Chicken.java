...
public class Chicken extends Bird {
	...
	public Chicken(int id, String name, int age, String type, String subType, String notes, String medicalCondition,
	...
	public void draw(Graphics g, ImagePanel imagePanel) {
		...
		try {                
	          image = ImageIO.read(new File("images/chicken.jpg"));
	...
	public static int getCount() {
		System.out.println("chicken count " + count);
		return count;
	}
