...
public class Sparrow extends Bird {
	...
	public Sparrow(int id, String name, int age, String type, String subType, String notes, String medicalCondition,
	...
	public void draw(Graphics g, ImagePanel imagePanel) {
		...
		try {                
	          image = ImageIO.read(new File("images/sparrow.jpg"));
